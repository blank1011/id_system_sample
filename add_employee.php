...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO employees (full_name, employee_number, date_received, expiration_date, comments) VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("sssss", $full_name, $employee_number, $date_received, $expiration_date, $comments);
...
<head>
    ...
    <title>Add Employee - ID System</title>
    <style>
        body { 
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Enter employee details for ID creation</p>
        </div>

...
if ($search) {
    $query .= " AND (full_name LIKE '%$search%' OR employee_number LIKE '%$search%')";
}
...
<head>
    ...
    <title>View Employees - ID System</title>
    <style>
        body { 
...
<body>
    <div class="container">
        <div class="header">
            <h1><i class="fas fa-user-tie"></i> Employee Records</h1>
            <p>View and manage all employee ID records</p>
        </div>
        
        <?php
        // Calculate statistics
        $total_employees = $conn->query("SELECT COUNT(*) as count FROM employees")->fetch_assoc()['count'];
        $active_employees = $conn->query("SELECT COUNT(*) as count FROM employees WHERE expiration_date >= CURDATE()")->fetch_assoc()['count'];
        $expired_employees = $conn->query("SELECT COUNT(*) as count FROM employees WHERE expiration_date < CURDATE()")->fetch_assoc()['count'];
        ?>
        ...
        <div class="stats-bar">
            ...
            <div class="stat-item">
                <div class="stat-number"><?php echo $expired_employees; ?></div>
        ...
        <?php else: ?>
            <div class="no-data">
                ...
                <p>No employee records have been added yet.</p>
                <a href="add_employee.php" class="btn btn-primary" style="margin-top: 15px;">

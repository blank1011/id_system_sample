...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("UPDATE employees SET full_name = ?, employee_number = ?, date_received = ?, expiration_date = ?, comments = ? WHERE id = ?");
    $stmt->bind_param("sssssi", $full_name, $employee_number, $date_received, $expiration_date, $comments, $id);
    ...
    <div class="container">
        ...
        <form method="POST" action="">
            ...
            <div class="form-group">
                ...
                <input type="text" name="employee_number" value="<?php echo htmlspecialchars($employee['employee_number']); ?>" required>
            </div>
            <div class="form-group">
                <label>Date ID Received:</label>
                <input type="date" name="date_received" value="<?php echo $employee['date_received']; ?>" required>
            </div>
            <div class="form-group">
                <label>Expiration Date:</label>
                <input type="date" name="expiration_date" id="expiration_date" value="<?php echo $employee['expiration_date']; ?>" required>
            </div>
            <div class="form-group">
                <label>Comments:</label>
                <textarea name="comments" id="comments"><?php echo htmlspecialchars($employee['comments'] ?? ''); ?></textarea>
            </div>
